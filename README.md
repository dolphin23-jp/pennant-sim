...
現行ゲームにはCPU球団の自動引退処理がないため、この診断だけは全球団へ簡易ルールを適用します。40歳以上、または35歳以上かつOVR 50以下の選手を対象にし、さらに毎年6巡のドラフト枠を空けるため低評価選手を整理します。このルールは `scripts/franchise-drift.ts` 内だけにあり、プレイヤー向けオフシーズンUIや実際のゲーム進行は変更しません。
